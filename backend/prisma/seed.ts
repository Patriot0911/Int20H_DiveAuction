...
async function main() {
  ...
  await prisma.auctionImage.createMany({
    data: [
      ...
      { auctionId: 5, url: '/auctions/phone1.png' },
      { auctionId: 5, url: '/auctions/phone2.jpg' },
      { auctionId: 6, url: '/auctions/sofa1.jpg' },
      { auctionId: 6, url: '/auctions/sofa2.jpg' },
      { auctionId: 7, url: '/auctions/red1.jpg' },
      { auctionId: 7, url: '/auctions/red2.jpg' },
      { auctionId: 8, url: '/auctions/book1.jpg' },
      { auctionId: 8, url: '/auctions/book2.jpg' },
    ],
  });
